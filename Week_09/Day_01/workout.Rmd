...
easr <- area %>% 
  ...
  geom_text(aes(label = "Incidences", x = 2019.5, y = 900), color = "red") +
  geom_text(aes(label = "Easr", x = 2020, y = 550), color = "dark green") +
...
wasr <- area %>% 
  ...
  geom_text(aes(label = "Incidences", x = 2019.5, y = 900), color = "red") +
  geom_text(aes(label = "Wasr", x = 2020, y = 280), color = "dark green") +
...
sir <- area %>% 
  ...
  geom_text(aes(label = "Incidences", x = 2019.5, y = 900), color = "red") +
  geom_text(aes(label = "SIR", x = 2020, y = 100), color = "dark green") +
