...
comb_hb %>% 
  ...
  scale_x_discrete(breaks = c("05 to 09", "15 to 19", "25 to 29", 
                              "35 to 39", "45 to 49", "55 to 59", 
                              "65 to 69", "75 to 79", "85 +")) +
  facet_wrap(~ cancer_site) +
  labs(title = "Age Range by Tpye of Cancer \n",
       y = "Number of Incidences \n",
       x = "Age Range \n",
...
area %>% 
  ...
  geom_line(size=1.2) +
  scale_x_continuous(limits = c(1995, 2020)) +
  scale_y_continuous(breaks = c(0, 50, 100, 150, 200), limits = c(0, 230)) +
  labs(
       x = "Year",
       y = "Number of Incidences \n",
       colour = "Gender") +
...
```{r}
# standardised incidence ratio compared to NHS Borders
...
#                   ymax = crude_rate + cure_diff_up), 
#               fill = "grey70", alpha=0.5) +
#   labs(title = "Crude Rate by NHS Borders",
#        x = "Year",
#        y = "Number of Incidences \n") +
#   theme(plot.title = element_text(hjust = 0.5))
# 
...
#               fill = "grey70", alpha=0.5) +
#   labs(title = "European Age-Standardised by NHS Borders",
#        x = "Year",
#        y = "Number of Incidences \n") +
#   theme(plot.title = element_text(hjust = 0.5))
# 
...
#               fill = "grey70", alpha=0.5) +
#   labs(title = "World Age-Standardised by NHS Borders",
#        x = "Year",
#        y = "Number of Incidences \n") +
#   theme(plot.title = element_text(hjust = 0.5))
# 
...
#               fill = "grey70", alpha=0.5) +
#   labs(title = "Age-Standardised by NHS Borders",
#        x = "Year",
#        y = "Number of Incidences \n") +
#   theme(plot.title = element_text(hjust = 0.5))
# 
