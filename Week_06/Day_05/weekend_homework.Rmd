...
The p-value is equal to or greater than α=0.05 ie less than 95% and so we fail to reject H0. There is insufficient evidence to conclude that omnivores sleep for significantly longer than herbivores on average.
...
H0 : domesticated = 0.05
Ha : domesticated > 0.05
α=0.05 (> 95% )
...
null_dist_flag %>%
  visualise() +
  shade_p_value(direction = "right", obs_stat = obs_stat_flag)
```
...
H0 the proportion of the town population who are aware of the shop: 40% or lower
Ha the proportion of the town population who are aware of the shop: greater than 40%
